...
<!-- Service Providers -->
<li class="treeview">
    <a href="#"><i class="fa fa-graduation-cap"></i> <span>Service Providers</span> <i class="fa fa-angle-left pull-right"></i></a>
    <ul class="treeview-menu">
        <li><a href="{{ backpack_url('bioprofile') }}"><i class="fa fa-users"></i> <span>Service Providers</span></a></li>
        <li><a href="{{ route('import.create') }}"><i class="fa fa-file-excel-o"></i> <span>Import Service Providers</span></a></li>
    </ul>
</li>
